                ...
                <View style={[styles.productAdminInfo, { flex: 1 }]}>
                  ...
                  <View style={{ flexDirection: 'row', gap: 8, marginTop: 4 }}>
                    <Text style={[styles.productAdminDesc, { color: item.is_premium ? '#D4A017' : '#4CAF50', fontWeight: '600' }]}>
                      {item.is_premium ? `Premium ${item.price}â‚¬` : 'Free'}
                    </Text>
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { paddingBottom: insets.bottom + 16 }]}>
            ...
            <ScrollView style={styles.modalScroll}>
              ...
              <TextInput style={styles.modalInput} value={partnerName} onChangeText={setPartnerName} placeholderTextColor={Colors.text.light} placeholder="Restaurant SpiĹˇ" />
              ...
              <TextInput style={styles.modalInput} value={partnerAddress} onChangeText={setPartnerAddress} placeholderTextColor={Colors.text.light} placeholder="SpiĹˇskĂ© Podhradie, Slovakia" />
              <Text style={styles.label}>Order</Text>
