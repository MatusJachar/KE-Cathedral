...
const TEXTS = {
  title: {
    sk: 'Podpora aplikácie',
    en: 'Support the App',
    de: 'App unterstützen',
    pl: 'Wesprzyj aplikację',
    hu: 'Támogassa az alkalmazást',
    fr: "Soutenir l'application",
    es: 'Apoyar la aplicación',
    it: "Supporta l'applicazione",
    uk: 'Підтримати додаток',
  },
  description: {
    ...
    de: 'Diese App ist kostenlos und wurde von einem unabhängigen Entwickler mit Liebe zum Dom St. Elisabeth erstellt. Wenn sie Ihnen gefällt, unterstützen Sie ihre weitere Entwicklung.',
    ...
    fr: "Cette application est gratuite et a été créée par un développeur indépendant avec amour pour la Cathédrale Sainte-Élisabeth. Si elle vous plaît, soutenez son développement.",
    es: 'Esta aplicación es gratuita y fue creada por un desarrollador independiente con amor por la Catedral de Santa Isabel. Si te gusta, apoya su desarrollo.',
    it: "Questa app è gratuita ed è stata creata da uno sviluppatore indipendente con amore per la Cattedrale di Sant'Elisabetta. Se ti piace, supporta il suo sviluppo.",
    uk: 'Цей додаток безкоштовний і був створений незалежним розробником з любов’ю до Собору св. Єлизавети.',
  },
  donateBtn: {
    sk: 'Podporiť cez Ko-fi',
    en: 'Support via Ko-fi',
    de: 'Via Ko-fi unterstützen',
    pl: 'Wesprzyj przez Ko-fi',
    hu: 'Támogatás Ko-fi-n keresztül',
    fr: 'Soutenir via Ko-fi',
    es: 'Apoyar vía Ko-fi',
    it: 'Supporta tramite Ko-fi',
...
export default function SupportScreen() {
  ...
  const lang = (language || 'sk') as keyof typeof TEXTS.title;
